	...
	<div id="primary" class="content-area">
			...
			<div class="main-container">
				...
				<div class="row site-module-inner">
					<?php $query = new WP_Query('cat='.get_cat_ID('Research').' & post_per_page=-1'); $counter = 1; ?>
				...
				<div class="row site-module-inner">
					<?php $query = new WP_Query('cat='.get_cat_ID('Teaching and Learning').'&post_per_page=-1'); $counter = 1; ?>
					<?php while ( $query->have_posts() && !( $counter > 3)  ) : $query->the_post(); ?>
				...
				<div class="row site-module-inner">
					<?php $query = new WP_Query('cat='.get_cat_ID('News').'&post_per_page=-1'); $counter = 1; ?>
					<?php while ( $query->have_posts() && !( $counter > 3 ) ) : $query->the_post(); ?>
					<div class="item">
				...
				<div class="row site-module-inner">
					<?php $query = new WP_Query('cat='.get_cat_ID('Events').'&post_per_page=-1'); $counter = 1?>
